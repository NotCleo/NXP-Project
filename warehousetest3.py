...
class WarehouseExplore(Node):
    ...
    def camera_image_callback(self, message):
        ...
        if decoded_objects:
            ...
            self.get_logger().info(f"[INFO] QR Code(s) FOUND: {[obj.data.decode('utf-8') for obj in decoded_objects]}")
        ...
        if detected_objects:
            ...
            self.get_logger().info(f"[DEBUG] Published shelf data: {shelf_data_message}")
